## Credits
This project uses visual assets from external sources for educational and prototype purposes.

# Sign Language
- Source: Canva
- Creator: Caldwell Jones Reynaldo
            @caldwelljonesreynaldo
- License: Canva Free
...
## Furret logo
- Source: Vexels
- Page: https://es.vexels.com/png-svg/vista-previa/203118/ilustracion-de-lindo-huron-de-pie
- Format used: PNG
- Original publication date shown: 20/01/2020
- Usage in project: Navbar / mascot placeholder for SigniAcademy
