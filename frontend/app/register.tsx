      ...
      >
        <ScreenContainer size="auth">
          <NBCard style={styles.card}>
            ...
            <Text style={styles.subtitle}>{i18n.register.subtitle}</Text>

            <View style={styles.form}>
              <NBInput
                placeholder={i18n.register.name}
                value={name}
            ...
            <View style={styles.linkRow}>
              <Text style={styles.linkText}>{i18n.register.hasAccount} </Text>
              <Text
